...
WebdriverIO एनपीएम और अन्य रजिस्ट्रियों के लिए विभिन्न मॉड्यूल प्रकाशित करता है जिनका उपयोग आप अपने स्वयं के स्वचालन ढांचे के निर्माण के लिए कर सकते हैं। WebdriverIO सेटअप प्रकार के बारे में अधिक दस्तावेज़ [यहाँ](../setuptypes)देखें।
...
- `options`: [वेबड्राइवर विकल्प](../configuration#webdriver-options)
...
WebdriverIO सत्र प्रारंभ करता है। उदाहरण में प्रोटोकॉल पैकेज के रूप में सभी आदेश शामिल हैं लेकिन अतिरिक्त उच्च क्रम कार्यों के साथ, [एपीआई डॉक्स](../api)देखें।

##### मापदंडों

- `options`: [वेबड्राइवर विकल्प](../configuration#webdriverio)
- `modifier`: फ़ंक्शन जो क्लाइंट इंस्टेंस को वापस आने से पहले संशोधित करने की अनुमति देता है
...
- `multiremoteOptions`: ब्राउज़र नाम और उनके [वेबड्राइवरआईओ विकल्प](../configuration#webdriverio)का प्रतिनिधित्व करने वाली चाबियों वाला एक ऑब्जेक्ट।
...
WebdriverIO के [ब्राउज़र रनर](../runner#browser-runner) का उपयोग करके यूनिट या घटक परीक्षण चलाते समय आप अपने परीक्षणों के लिए मॉकिंग उपयोगिताओं का आयात कर सकते हैं, जैसे:
